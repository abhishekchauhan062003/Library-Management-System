...
public class Library {
    ...
    private static final String PASSWORD = "123@gehu";
	...
	public static void main(String[] args)
	{
        ...
        if (console == null) {
            System.err.println("No console found. Please run the program in a console environment.");
            System.exit(1);
        }

		Scanner input = new Scanner(System.in);
        System.out.println("********************Welcome to the GEHU Library!********************");
        System.out.println("Please enter your credentials to log in.");

        boolean loggedIn = false;

        // Prompt for username and password until the correct credentials are entered
        while (!loggedIn) {
            ...
            if (usernameInput.equals(USERNAME) && p.equals(PASSWORD)) {
                loggedIn = true;
                System.out.println("\nLogin successful. Welcome to the library management system!");
            } else {
